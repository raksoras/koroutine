...
exports.future = function (timeout) {
  ...
  if (! resume) {
    throw new Error('koroutine.future() called without active koroutine');
  }
  let timer = null;
...
exports.sleep = function (ms) {
  if (!this.resume) {
    throw new Error('koroutine.sleep() called without active koroutine');
  }
...
exports.defer = function () {
  if (!this.resume) {
    throw new Error('koroutine.defer() called without active koroutine');
  }
